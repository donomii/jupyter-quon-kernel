 ...
 * `docker pull brendanrius/jupyter-quon-kernel`
 * `docker run -p 8888:8888 brendanrius/jupyter-quon-kernel`
...
### Step-by-step:
 * `pip install jupyter-quon-kernel`
 * `install_quon_kernel`
...
```bash
git clone https://github.com/brendan-rius/jupyter-quon-kernel.git
cd jupyter-quon-kernel
docker run -v $(pwd):/jupyter/jupyter_quon_kernel/ -p 8888:8888 brendanrius/jupyter-quon-kernel
```
